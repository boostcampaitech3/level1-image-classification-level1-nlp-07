...
def train(data_dir, model_dir, args):
    ...
    # wandb.init(project="mask_classification", entity="level1-nlp-07", name="wj_age_cls")
    wandb.init(project="mask_classification", entity="level1-nlp-07", name="test_wj_age_cls_seed")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="AgeDataset")
    ...
    parser.add_argument('--name', default="wj_age_cls")
