...
def train(data_dir, model_dir, args):
    ...
    # wandb.init(project="mask_classification", entity="level1-nlp-07", name="wj_gender_cls")
    wandb.init(project="mask_classification", entity="level1-nlp-07", name="test_wj_gender_cls_base_aug")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="GenderDataset")
    ...
    parser.add_argument('--name', default="wj_gender_cls")
