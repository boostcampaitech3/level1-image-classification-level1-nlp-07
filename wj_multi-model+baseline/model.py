...
class Darknet53(nn.Module):
    def __init__(self, num_classes, block=DarkResidualBlock):
...
class ViT(nn.Module):
    def __init__(self, *, num_classes, image_size=(512, 384), patch_size=64, dim=1024, depth=6, heads=16, mlp_dim=2048, pool = 'cls', channels = 3, dim_head = 64, dropout = 0.1, emb_dropout = 0.1):
        super().__init__()
